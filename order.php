...
<body>
     <?php
error_reporting(0);
echo "<font color='white' size='5'><bold><hr class='hr-19'>INSTAUP ORDER PLACER<hr class='hr-19'><bold>";
...
$ll='https%3A%5C%2F%5C%2Finstagram.fccu3-1.fna.fbcdn.net%5C%2Fv%5C%2Ft51.2885-15%5C%2Fe35%5C%2Fs150x150%5C%2F264420143_435496831548995_8076441957316773167_n.jpg%3F_nc_ht%3Dinstagram.fccu3-1.fna.fbcdn.net%26_nc_cat%3D111%26_nc_ohc%3DvWrY6qsKOOAAX9ZgJLH%26edm%3DAPU89FABAAAA%26ccb%3D7-4%26oh%3D00_AT_GHVnpr10j1bCs8Dx5unohvTyp_1DgOtu8It7P_Nmpfw%26oe%3D61B616B1%26_nc_sid%3D86f79a';
 ...
 $data0='gift=0&order_count=200&user_id='.$uid.'&tokenV2='.$tkv.'&start_value=145108&media_url=%7B%22media_url%22%3A%22https%3A%2F%2Fwww.instagram.com%2F'.$ll.'%22%2C%22user_name%22%3A%'.$fname.'%22%7D&order_id='.$uidx;
...
<input type='text' name='oid'  class='text' placeholder='victim id' required><br><br>
<input type='text' name='uid'  class='text' placeholder='Your insta id' required><br><br>";
